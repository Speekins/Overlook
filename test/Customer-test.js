...
import {
  testCustomers, testBookings, customerBookings,
  oldBookings, sortedBookings
...
describe('customer', () => {
  ...
  beforeEach(() => {
    customer = new Customer(testCustomers[0], sortedBookings)
    customer2 = new Customer(testCustomers[1], sortedBookings)
  })
